    ...
    <div class="common-layout">
        ...
        <el-header>
            <!-- <div class="search-container">
                ...
                <el-button style="height: 40px; margin-left: 10px;" @click="onSearch">搜索</el-button>
                </div>
            </div> -->
            <Header></Header>
        </el-header>
        <el-main>
            <div style="margin-bottom: 20px; padding: 10px; background-color: #f0f0f0; border-radius: 10px; text-align: center; font-family: 'STCaiyun'; letter-spacing: 10px;">
                <span style="color: #007bff; font-size: 20px;">{{ titles }}</span>
            </div>
...
export default{
    ...
    methods:{
        ...
        queryCourseByIds(){
            const title  = localStorage.getItem("label_title")
            const ids =  localStorage.getItem("label_course")
            this.titles = title
            instance({
                method:"post",
                url:"/api/course/course/queryByIds",
                data:ids,
                headers:{
