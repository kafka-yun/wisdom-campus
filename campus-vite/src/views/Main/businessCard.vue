...
<div class="wrapper">
	...
	<div class="profile">
		<img src="https://th.bing.com/th/id/OIP.MO9kKuliwR3AlBcVAxgsTgHaHa?rs=1&pid=ImgDetMain" class="thumbnail">
		<div class="check"><i class="fas fa-check"></i></div>
		<h3 class="name">关于作者</h3>
		<button type="button" class="btn" @click="toIndex">主页</button>
	</div>
...
export default{
  data(){
    ...
    toIndex(){
      window.open("https://gitee.com/gong-chengyun","_blank")
    }
  }
}
</script>
