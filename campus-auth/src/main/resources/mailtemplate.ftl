    ...
    <table cellpadding="0" align="center"
        ...
        <tr>
            <th valign="middle"
                ...
                <font face="微软雅黑" size="5" style="color: rgb(255, 255, 255); ">智慧学堂</font>
            </th>
        </tr>
        <tr>
            <td style="word-break:break-all">
                <div style="padding:25px 35px 40px; background-color:#fff;opacity:0.8;">
                    ...
                    <!-- 中文 -->
                    <p>您好！感谢您使用智慧学堂，您的账号正在进行邮箱验证，验证码为：<font color="#ff8c00">{0}</font>，有效期3分钟，请尽快填写验证码完成验证！</p><br>
                    <!-- 英文 -->
                    <h2 style="margin: 5px 0px; ">
                        <font color="#333333" style="line-height: 20px; ">
                            <font style="line-height: 22px; " size="4">
                    ...
                    <p>Hello! Thanks for using wisdom campus, your account is being authenticated by email, the
